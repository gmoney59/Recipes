...
def generateFakeRecipes():
    ...
    ("Hearty Beef Stew", "grandmaImage", "Hearty_Beef_Stew.JPG"),
    ("Quaker Barley Stroganoff Stew", "grandmaImage", "Quaker_Barley_Stroganoff_Stew.JPG"),
    ("Babe's Chicken Cacciatore", "grandmaImage", "Babes_Chicken_Cacciatore.JPG"),
    ("Eggplant Italienne", "grandmaImage", "Eggplant_Italienne.jpg"),
	("Triple Bean Casserole", "grandmaImage", "Triple_Bean_Casserole.JPG")):
